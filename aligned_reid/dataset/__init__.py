...
def create_dataset(
    ...
    part='trainval',
    **kwargs):
  assert name in ['market1501', 'cuhk03', 'duke', 'combined', 'tiger'], \
  ...
  if name == 'market1501':
    im_dir = ospeu('~/yujiwen/AlignedReID-Re-Production-Pytorch-master/images')
    partition_file = ospeu('~/yujiwen/AlignedReID-Re-Production-Pytorch-master/partitions.pkl')
    ...
    im_dir = '/home/iccv2019/yujiwen/AlignedReID-Re-Production-Pytorch-master/images'
    partition_file = '/home/iccv2019/yujiwen/AlignedReID-Re-Production-Pytorch-master/partitions.pkl'
