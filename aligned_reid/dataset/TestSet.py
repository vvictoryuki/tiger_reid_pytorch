...
class TestSet(Dataset):
  ...
  def eval(
    ...
    with measure_time('Extracting feature...'):
      ...
      #print('-------->>>>im_names size:',im_names.shape)
      # new_im_names = []
      # print(ids.shape,ids.dtype,ids[0:100])
      # for i in range(im_names.shape[0]):
      #   new_im_name = im_names[i].split('_')[-1].split('.')[0]
      #   new_im_names.append(int(new_im_name))
      # new_im_names = np.array(new_im_names)
      # print(new_im_names[0])
      # np.savetxt('/home/iccv2019/yujiwen/AlignedReID-Re-Production-Pytorch-master/dist_mat_dir/im_names.txt',new_im_names)
      # #print(im_names[0])
      # print("im_names.txt done!!")
      # np.savetxt('/home/iccv2019/yujiwen/AlignedReID-Re-Production-Pytorch-master/dist_mat_dir/marks.txt',marks)
      # print("marks.txt is done!!")
      # np.savetxt('/home/iccv2019/yujiwen/AlignedReID-Re-Production-Pytorch-master/dist_mat_dir/ids.txt',ids)
      # print("ids.txt is done!!")
    ...
    if to_re_rank:
      with measure_time('Re-ranking...'):
        ...
        # np.savetxt('/home/iccv2019/yujiwen/AlignedReID-Re-Production-Pytorch-master/dist_mat_dir/re_r_dist_mat.txt',re_r_global_q_g_dist)
        # print("dist_mat.txt is done!!")
