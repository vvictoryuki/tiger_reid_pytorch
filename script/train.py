...
class Config(object):
  def __init__(self):
    ...
    parser.add_argument('-d', '--sys_device_ids', type=eval, default=(6,7))
    parser.add_argument('-r', '--run', type=int, default=1)
    parser.add_argument('--set_seed', type=str2bool, default=False)
    parser.add_argument('--dataset', type=str, default='tiger',
                        choices=['market1501', 'cuhk03', 'duke', 'combined', 'tiger'])
    parser.add_argument('--trainset_part', type=str, default='train',
    ...
    parser.add_argument('-idlw', '--id_loss_weight', type=float, default=0.3)
